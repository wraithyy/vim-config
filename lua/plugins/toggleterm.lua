		...
		config = function()
			...
			toggleterm_manager.setup({
				...
				mappings = {                                                              -- key mappings bound inside the telescope window
					i = {
						["<CR>"] = { action = require('toggleterm-manager').actions.toggle_term, exit_on_action = false }, -- toggles terminal open/closed
						["<C-i>"] = { action = require('toggleterm-manager').actions.create_term, exit_on_action = false }, -- creates a new terminal buffer
